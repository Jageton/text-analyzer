...
class AgglomerativeClustering:
    ...
    def __init__(self, n_clusters: int = 2, affinity: AffinityType = AffinityType.euclidean.value,
                 memory=None, connectivity=None, compute_full_tree='auto',
                 linkage: LinkageType = LinkageType.ward.value, distance_threshold: float = None,
    ...
    def run(self, X):
        clustering = skAgglomerativeClustering(n_clusters=self.n_clusters, affinity=self.affinity, memory=self.memory,
